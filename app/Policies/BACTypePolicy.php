...
class BACTypePolicy
{
    ...
    {
        return $user->can('view_any_b::a::c::type');
    }

    /**
     * Determine whether the user can view the model.
     */
    public function view(User $user, BACType $bACType): bool
    {
        return $user->can('view_b::a::c::type');
    }
    ...
    {
        return $user->can('create_b::a::c::type');
    }

    /**
     * Determine whether the user can update the model.
     */
    public function update(User $user, BACType $bACType): bool
    {
        return $user->can('update_b::a::c::type');
    }

    /**
     * Determine whether the user can delete the model.
     */
    public function delete(User $user, BACType $bACType): bool
    {
        return $user->can('delete_b::a::c::type');
    }
