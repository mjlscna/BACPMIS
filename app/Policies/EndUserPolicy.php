...
class EndUserPolicy
{
    ...
    {
        return $user->can('view_any_end::user');
    }
    ...
    {
        return $user->can('create_end::user');
    }
    ...
    {
        return $user->can('update_end::user');
    }
    ...
    {
        return $user->can('delete_end::user');
    }
