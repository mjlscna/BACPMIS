...
class FundSourcePolicy
{
    ...
    {
        return $user->can('view_any_fund::source');
    }
    ...
    {
        return $user->can('view_fund::source');
    }
    ...
    {
        return $user->can('create_fund::source');
    }
    ...
    {
        return $user->can('update_fund::source');
    }
    ...
    {
        return $user->can('delete_fund::source');
    }
