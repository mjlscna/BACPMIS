            ...
            <div class="p-8 pr-10 inline-block align-middle w-full overflow-x-auto">
                <div
                    ...
                    <div class="relative max-h-[600px] overflow-auto">
                        <table class="min-w-[1500px] divide-y divide-gray-200 dark:divide-neutral-700 table-fixed">
                            ...
                            <tbody
                                ...
                                @foreach ($procurements as $procurement)
                                    <tr>
                                        ...
                                        <td
                                            class="px-6 py-1 text-center text-sm text-black dark:text-neutral-200 relative">
                                            <span
