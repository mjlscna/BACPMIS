                    ...
                    <div class="bg-white p-4 rounded-xl shadow border border-gray-200">
                        <div class="grid grid-cols-2 md:grid-cols-5 gap-4">
                            ...
                            <x-forms.select id="divisions_id" label="Division" model="form.divisions_id" :form="$form"
                                :options="$divisions" optionValue="id" optionLabel="divisions" :required="true"
                            ...
                            <div class="grid grid-cols-4 gap-4">
                                ...
                                <div class="col-span-1">
                                    <x-forms.input id="expense_class" label="Expense Class" model="form.expense_class"
                                        :form="$form" :required="false" :viewOnly="$viewOnlyTab1" textAlign="right" />
                                </div>
                            ...
                            <div class="flex justify-center">
                                <div class="bg-white p-4 rounded-xl border border-gray-200 inline-block">
                                    ...
                                    <x-forms.select id="mode_of_procurement_{{ $modeIndex }}"
                                        ...
                                        :required="false" :viewOnly="$viewOnlyTab2 || $isModeLocked"
                                        wireModifier="defer" />
                                </div>
                            </div>
                                ...
                                <div class="grid grid-cols-5 gap-4">
                                    ...
                                    <div class="col-span-full">
                                        <div class="w-full md:w-16">
                                            <x-forms.input id="bidding_number_{{ $modeIndex }}_{{ $bidIndex }}"
                                                label="Bidding #"
                                                model="form.modes.{{ $modeIndex }}.bid_schedules.{{ $bidIndex }}.bidding_number"
                                                :form="$form" :viewOnly="$viewOnlyTab2 || $isScheduleLocked"
                                                textAlign="right" maxlength="2" />
                                        </div>
                                    </div>

                                    <x-forms.input id="ib_number_{{ $modeIndex }}_{{ $bidIndex }}" label="IB No."
                                    ...
                                    <x-forms.date id="pre_proc_conference_{{ $modeIndex }}_{{ $bidIndex }}"
                                        label="Pre-Proc Conference"
                                        model="form.modes.{{ $modeIndex }}.bid_schedules.{{ $bidIndex }}.pre_proc_conference"
                                        :form="$form" :viewOnly="$viewOnlyTab2 || $isScheduleLocked" />

                                    <x-forms.date id="ads_post_ib_{{ $modeIndex }}_{{ $bidIndex }}" label="Ads/Post IB"
                                    ...
                                    <x-forms.date id="eligibility_check_{{ $modeIndex }}_{{ $bidIndex }}"
                                    ...
                                    <x-forms.select id="bidding_result_{{ $modeIndex }}_{{ $bidIndex }}"
                                    ...
                                    <x-forms.date id="ntf_bidding_date_{{ $modeIndex }}_{{ $bidIndex }}"
                                        label="NTF Bidding Date"
                                        model="form.modes.{{ $modeIndex }}.bid_schedules.{{ $bidIndex }}.ntf_bidding_date"
                                        :form="$form" :viewOnly="$viewOnlyTab2 || $isScheduleLocked" />

                                    <x-forms.input id="ntf_no_{{ $modeIndex }}_{{ $bidIndex }}" label="NTF No."
                                        model="form.modes.{{ $modeIndex }}.bid_schedules.{{ $bidIndex }}.ntf_no"
                                        :form="$form" :viewOnly="$viewOnlyTab2 || $isScheduleLocked"
                                        textAlign="right" />

                                    <x-forms.select id="ntf_bidding_result_{{ $modeIndex }}_{{ $bidIndex }}"
                                        label="Bidding Result" :options="[
                                                            'SUCCESSFUL' => 'SUCCESSFUL',
                                                            'UNSUCCESSFUL' => 'UNSUCCESSFUL',
                                                        ]"
                ...
                <div class="justify-center gap-4 mt-6">
                    <div class="bg-white p-4 rounded-xl shadow border border-gray-200">
                        <div class="grid grid-cols-6 gap-4">
                            ...
                            {{-- Remarks --}}
                            <div class="col-span-1">
                                <x-forms.select id="remarks_id" label="Remarks" model="form.remarks_id" :form="$form"
                                    :options="$remarks" optionValue="id" optionLabel="remarks" :required="false"
                                    :viewOnly="$viewOnlyTab3" />
                            </div>
